              ...
              {!showSuccessMessage ? (
                <>
                  ...
                  >
                    ...
                    <div>
                      <Label htmlFor="business-type">{t('contact.form.businessType')}</Label>
                      <Select onValueChange={(value) => setValue("businessType", value)}>
                        <SelectTrigger className={errors.businessType ? "border-red-500" : ""}>
                          <SelectValue placeholder={t('contact.form.selectBusinessType')} />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="autolavado">{t('contact.form.autolavado')}</SelectItem>
                          <SelectItem value="officina">{t('contact.form.officina')}</SelectItem>
                          <SelectItem value="galeria">{t('contact.form.galeria')}</SelectItem>
                          <SelectItem value="renta">{t('contact.form.renta')}</SelectItem>
                          <SelectItem value="otro">{t('contact.form.otro')}</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
